            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <p className="text-white-50 mb-4">
                  We are experienced software professionals. Our team delivers
                  great applications using deep technical knowledge and strong
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    We offer custom, high performance, user-friendly web-based
                    applications for every industry with ReactJS/Redux
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    We offer reliable, secure and clean software solutions
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    Our dedicated team produce successful project
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    We are really customer-obsessed
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    ...
                    <div className="project-name">pfunctionPMTool</div>
                  </div>
                </a>
              </div>
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    ...
                    <div className="project-name">bayi-react</div>
                  </div>
                </a>
              </div>
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    ...
                    <div className="project-name">BiFunctionBPMTool</div>
                  </div>
                </a>
              </div>
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    ...
                    <div className="project-name">personal-blog</div>
                  </div>
                </a>
              </div>
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption">
                    ...
                    <div className="project-name">ChatInTalk</div>
                  </div>
                </a>
              </div>
              <div className="col-lg-4 col-sm-6">
                ...
                >
                  ...
                  <div className="portfolio-box-caption p-3">
                    ...
                    <div className="project-name">social-app-functions</div>
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                ...
                <div>+44 (746) 023-9206</div>
              </div>
              <div className="col-lg-4 mr-auto text-center">
                <i className="fas fa-envelope fa-3x mb-3 text-muted"></i>
                <a className="d-block" href="mailto:info@bifunction.com">
                  info@bifunction.com
                </a>
              </div>
            </div>
